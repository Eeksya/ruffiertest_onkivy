...
Результат запишите в соответствующее поле.''' + '[/color]'

txt_test2 = '[color=#000000]' + '''Выполните 30 приседаний за 45 секунд.\n 
Нажмите кнопку "Начать", чтобы запустить счетчик приседаний.\n
Делайте приседания со скоростью счетчика.''' + '[/color]'

txt_test3 = '[color=#000000]' + '''В течение минуты замерьте пульс два раза:\n 
за первые 15 секунд минуты, затем за последние 15 секунд.\n
Результаты запишите в соответствующие поля.'''  + '[/color]'

txt_sits = '[color=#000000]' + 'Выполните 30 приседаний за 45 секунд.' + '[/color]'